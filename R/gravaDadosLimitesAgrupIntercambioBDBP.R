...
#'
#' Faz a gravacao dos dados dos limites dos agrupamento de intercambios ao longo do horizonte de simulacao do NEWAVE no banco de dados do Balanco de Ponta (BDBP)
